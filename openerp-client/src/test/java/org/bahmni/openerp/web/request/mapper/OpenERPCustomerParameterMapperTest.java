...
//     String sex = "Male";
//     Customer customer = new Customer(name, patientId, village, sex);
//     List<Parameter> expectedParams = asList(
//       createParameter("name", name, "string"),
//       createParameter("ref", patientId, "string"),
//       createParameter("village", village, "string")
//     );
//     OpenERPRequest expectedRequest = new OpenERPRequest(
//       "res.partner",
//       "execute",
//       expectedParams
//     );
